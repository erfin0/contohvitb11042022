                    ...
                    <form>
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="inputEmail" type="text" placeholder="Enter your email name">
                            </div>
                            <!-- Form Group (Phone)-->
                            <div class="col-md-6">
                                <label class="small mb-1" for="inputNo">Phone Number</label>
                                <input class="form-control" id="inputNo" type="number" name="Phone Number" placeholder="Enter your Phone number">
                            </div>
                        </div>
                        <!-- Save changes button-->

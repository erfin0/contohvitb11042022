<template>
  <div class="container-fluid">
    ...
    <div class="text-center">
      ...
      <p class=" text-gray-800 mb-5">Halaman tidak ditemukan</p>
      <p class="text-gray-500 mb-0">apa yang anda pikir kan?</p>
      <h3>
        <a  class="btn-clipboard" @click="$router.go(-1)">kembali</a>
      </h3>
    </div>
  </div>
</template>
